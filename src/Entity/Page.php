 ...
 *
 * @ORM\Table(name="page")
 * @ORM\Entity(repositoryClass="Brisum\Stork\Bundle\CoreBundle\Repository\PageRepository")
 * @Gedmo\TranslationEntity(class="Brisum\Stork\Bundle\CoreBundle\Entity\PageTranslation")
 * @Gedmo\Loggable(logEntryClass="Brisum\Stork\Bundle\CoreBundle\Entity\PageLog")
 */
class Page implements TranslatableInterface
{
    ...
    {
        return $this->getId() . ':' . $this->getName() . ':' . $this->getTitle();
    }
