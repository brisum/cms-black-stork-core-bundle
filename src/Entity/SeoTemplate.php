 ...
 * @ORM\Entity(repositoryClass="Brisum\Stork\Bundle\CoreBundle\Repository\SeoTemplateRepository")
 * @Gedmo\TranslationEntity(class="Brisum\Stork\Bundle\CoreBundle\Entity\SeoTemplateTranslation")
 * @Gedmo\Loggable(logEntryClass="Brisum\Stork\Bundle\CoreBundle\Entity\SeoTemplateLog")
 */
class SeoTemplate
{
     ...
     * @var string
     *
     * @ORM\Column(name="template", type="string", length=255, unique=true)
     */
    private $template;
    ...
    /**
     * @param SeoTemplateTranslation $t
     */
    public function addTranslation(SeoTemplateTranslation $t)
    {
